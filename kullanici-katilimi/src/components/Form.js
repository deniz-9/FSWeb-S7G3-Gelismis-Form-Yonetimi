...
let schema = Yup.object().shape({
  name: Yup.string()
    .required("İsmi doldurunuz.")
    .min(3, "İsim en az 3 karakterden oluşmalıdır."),
  email: Yup.string()
    .email("Email adresini doldurunuz.")
    .required("E-mail adresini doldurmak zorunludur"),
  pass: Yup.string()
    .min(5, "Şifrenizi giriniz.")
    .required("Şifre en az 5 karakterli olmalıdır."),
  term: Yup.boolean().oneOf([true], "Onay Gerekiyor."),
});
